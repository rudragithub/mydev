...
colunArr = ['PS No', 'Name', 'Status', 'Available by', 'Base Account', 'Base DH', 'Primary Domain', 'Primary Skill', 'Additional Skills',
    ...
    'Selected for Client', 'Target Onboarding date', 'Target DH','CV'
]
colnWidth = ['140px', '220px', '135px', '140px', '186px', '80px', '100px', '100px', '100px', '100px', '100px', '50px','30px']
...
LntDB_Table[12][j] = "<div class='myfileupload-buttonbar '><label class='myui-button'><span >Upload</span><input id='file' type='file' name='files[]' /></label></div>"
